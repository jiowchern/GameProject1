...
dotnet .\Regulus.Application.Server.dll launchprotocol 53001 Regulus.Project.GameProject1.Protocol.dll Regulus.Project.GameProject1.Play.dll Regulus.Project.GameProject1.Play.Server
