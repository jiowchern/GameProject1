...
namespace WarriorBundle2FREE{ //MODIFY
    ...
    public class ReviewWindowEditor : EditorWindow{
		...
		private static string imagePath = "/Resources/Warrior-Pack-Bundle-2-FREE-Review.jpg"; //MODIFY
        ...
        [MenuItem("Window/Warrior Pack Bundle 2 FREE/Review")] //MODIFY
        static void Init(){
        ...
        void OnGUI(){		
            ...
            if (GUILayout.Button("Rate now!")){
				UnityEditorInternal.AssetStore.Open("content/42454"); //MODIFY
                DisableRating();
            }
